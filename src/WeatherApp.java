...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName) {
        ...
        // build API request URL with location coordinates from YT
        /*String urlString = "https://api.open-meteo.com/v1/forecast?" +
                "latitude=" + latitude + "&longitude=" + longitude +
                "&hourly=temperature_2m,relativehumidity_2m,weathercode,windspeed_10m&timezone=America%2FLos_Angeles";*/

        // build API request URL with location coordinates from YT !Attention, when copying url from API you have to delete the underscores between relative_humidity and so on!
        String urlString = "https://api.open-meteo.com/v1/forecast?" +
                "latitude=" + latitude + "&longitude=" + longitude +
